...
* [PowerShell](https://github.com/PowerShell/PowerShell) 7.3.11
* The [PowerShell extension for vscode](https://github.com/PowerShell/vscode-powershell) which works with code-server (2024.0.0)
...
* *latest:* contains the latest version of the PowerShell extension 2024.0.0 and PowerShell 7.3.11
